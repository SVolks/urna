...
let aviso = document.querySelector('.d-2-1');
let descricaoNumerosVP = document.querySelector('.d-2-2 span');
...
function comecarEtapa() {
    ...
    descricaoNumerosVP.innerHTML = etapa.avisoNumeros;
    lateral.innerHTML = '';
...
function atualizaInterface() {
    ...
    if(candidato.length > 0) {
        ...
        descricaoNumerosVP.style.display = 'none';
        ...
        seuVotoPara.style.display = 'block';
        aviso.style.display = 'none';
        descricaoNumerosVP.style.display = 'block';
